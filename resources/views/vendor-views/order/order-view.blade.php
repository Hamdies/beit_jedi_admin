...
@section('content')
    ...
    <div class="content container-fluid item-box-page order-page-modern">

    <div class="page-header d-print-none">

            <div class="order-header-card d-flex flex-wrap justify-content-between align-items-center">
                <div class="d-flex align-items-center mb-2 mb-md-0">
                    <div class="card-header-icon d-inline-flex mr-2 img">
                        <img src="{{dynamicAsset('public/assets/admin/img/orders.png')}}" alt="public">
                    </div>
                    <div>
                        <h1 class="order-header-title mb-1">تفاصيل الطلب #{{ $order['id'] }}</h1>
                        <p class="order-header-subtitle mb-0">مراجعة معلومات الطلب، العميل، حالة الدفع والتسليم بكل وضوح.</p>
                    </div>
                </div>
                <div class="d-flex ml-auto order-header-meta align-items-center">
                    <span class="mr-3">
