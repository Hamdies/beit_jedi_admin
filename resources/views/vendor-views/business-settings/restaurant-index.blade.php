...
@push('css_or_js')
    ...
    <style>
        .restaurant-setup-page-modern {
            background: #f5f7fa;
            padding: 1.75rem 0 1.5rem;
        }
        .restaurant-setup-header-card {
            border-radius: 24px;
            background: #ffffff;
        ...
        .restaurant-setup-header-title {
            font-size: 1.3rem;
            font-weight: 700;
            margin-bottom: .25rem;
            color: #1b3056;
        }
        .restaurant-setup-header-subtitle {
            font-size: .9rem;
            color: #6b7280;
            margin-bottom: 0;
        }
...
@section('content')
    <div class="content container-fluid restaurant-setup-page-modern">
        <!-- Page Header -->
        <div class="restaurant-setup-header-card d-flex flex-wrap justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h2 class="restaurant-setup-header-title mb-1">إعدادات المطعم</h2>
                    <p class="restaurant-setup-header-subtitle mb-0">اضبط طرق التوصيل، أنواع الأطباق وخيارات الطلب ليتوافق المطعم مع أسلوب عملك. المطعم مفتوح دائماً، ويمكنك إغلاقه مؤقتاً من المفتاح بالأسفل.</p>
                </div>
            </div>
        </div>
        <div class="card mb-3">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="tio-fastfood"></i> &nbsp; إعدادات عامة للمطعم
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
